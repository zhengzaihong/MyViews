...
open class RoundIconView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        val a = getContext().obtainStyledAttributes(attrs, R.styleable.RoundIconView, 0, 0)
        val cornerRadius = a.getDimensionPixelSize(R.styleable.RoundIconView_corner, 0)
        val roundedCorners = a.getInt(R.styleable.RoundIconView_roundedCorners, ALL_ROUNDED_CORNERS_VALUE)
        reverseMask = a.getBoolean(R.styleable.RoundIconView_reverseMask, reverseMask)
        a.recycle()
        init()
    ...
    constructor(context: Context, attrs: AttributeSet, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        val a = getContext().obtainStyledAttributes(attrs, R.styleable.RoundIconView, defStyleAttr, 0)
        val cornerRadius = a.getDimensionPixelSize(R.styleable.RoundIconView_corner, 0)
        val roundedCorners = a.getInt(R.styleable.RoundIconView_roundedCorners, ALL_ROUNDED_CORNERS_VALUE)
        reverseMask = a.getBoolean(R.styleable.RoundIconView_reverseMask, reverseMask)
        a.recycle()

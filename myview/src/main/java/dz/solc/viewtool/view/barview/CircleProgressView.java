...
public class CircleProgressView extends ProgressBar {
    ...
    private void initPaint() {
        ...
        mNormalPaint.setStyle(
                mProgressStyle == PROGRESS_STYLE_FILL_IN_ARC ? Paint.Style.FILL : Paint.Style.STROKE);
    ...
    private void obtainAttributes(AttributeSet attrs) {
        ...
        mProgressStyle = ta.getInt(R.styleable.CircleProgressView_progressStyle, PROGRESS_STYLE_NORMAL);
        // 获取三种风格通用的属性
        mNormalBarSize =
                (int) ta.getDimension(R.styleable.CircleProgressView_progressNormalSize, mNormalBarSize);
        mNormalBarColor =
                ta.getColor(R.styleable.CircleProgressView_progressNormalColor, mNormalBarColor);

        mReachBarSize =
                (int) ta.getDimension(R.styleable.CircleProgressView_progressReachSize, mReachBarSize);
        mReachBarColor = ta.getColor(R.styleable.CircleProgressView_progressReachColor, mReachBarColor);

        mTextSize = (int) ta.getDimension(R.styleable.CircleProgressView_progressTextSize, mTextSize);
        mTextColor = ta.getColor(R.styleable.CircleProgressView_progressTextColor, mTextColor);
        mTextSkewX = ta.getDimension(R.styleable.CircleProgressView_progressTextSkewX, 0);
        ...
        mRadius = (int) ta.getDimension(R.styleable.CircleProgressView_progressRadius, mRadius);
        ...
        switch (mProgressStyle) {
            ...
            case PROGRESS_STYLE_FILL_IN_ARC:
                ...
                mInnerPadding =
                        (int) ta.getDimension(R.styleable.CircleProgressView_innerPadding, mInnerPadding);
                mOuterColor = ta.getColor(R.styleable.CircleProgressView_outerColor, mReachBarColor);
                mOuterSize = (int) ta.getDimension(R.styleable.CircleProgressView_outerSize, mOuterSize);
